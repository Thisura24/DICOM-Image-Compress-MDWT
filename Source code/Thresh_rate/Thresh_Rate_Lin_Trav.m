...
% Here Adaptive quantization with Linear Traversal is used.
...
for i = 1:numel(fileNames)
    ...
    for n= 0.2: 0.03 : 0.99
        ...
        V1filtNew = VHDreshaped(1:rowsA1 , 1:coloumnsA1) * q;
        H1filtNew = VHDreshaped(1:rowsA1 , (coloumnsA1 + 1) : coloumnsA1*2) * q;
        D1filtNew = VHDreshaped(1:rowsA1 , (coloumnsA1*2 + 1) : coloumnsA1*3) * q;
        ...
        SSIM = ssim(reconstructedImage,img);
        RMSE = sqrt(MSE);
